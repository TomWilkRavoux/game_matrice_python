...
class Joueur:
    ...
    def deplacer(self, direction):
        ...
        if self.niveau.grille[new_x][new_y] == "1":  # Si c'est un obstacle
            ...
            if des <= 3:
                ...
                if self.vie <= 0:
                    ...
                    return False
                return True  # Le joueur bouge pas mais continue le jeu

        # Mise à jour de la grille
        self.niveau.grille[self.x][self.y] = str(random.randint(0, 1))  # Remplace l'ancienne position
